...
<body>
    <div id="app">
        <header class="navbar navbar-expand-lg shadow" style="background-color: #ffffff;">
            <div class="container-fluid">
                ...
                @auth
                <ul class="nav navbar-nav  col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 ms-5">

                    <li><a href="{{route('home')}}" class="nav-link px-2 fw-bolder {{ Route::currentRouteName() == 'home' ? 'active  link-secondary' : 'link-dark' }}">Home</a></li>
