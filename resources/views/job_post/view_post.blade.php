...
<div class="container my-5 d-flex justify-content-center shadow-sm">
    ...
    <div class="row g-0">
        ...
        <div class="col-md-9">
            <div class="card-body">
                ...
                <p class="card-subtitle mb-2 text-muted"><h5 class="d-inline pe-2 py-2"><strong>Description :</strong>{{ $jobPost->description }}</p>
                <p class="card-text">
